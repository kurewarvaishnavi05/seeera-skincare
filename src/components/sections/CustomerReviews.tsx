        ...
        >
          {reviews.map((review, i) => (
            <motion.div 
              ...
              className="min-w-[280px] md:min-w-[320px] lg:min-w-[380px] shrink-0 snap-start bg-dark-brown-red backdrop-blur-sm p-8 rounded-2xl hover:-translate-y-2 hover:shadow-2xl hover:shadow-dark-brown-red/20 transition-all duration-700 border border-dark-brown-red/50 group flex flex-col"
            >
